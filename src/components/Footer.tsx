    ...
    <footer className="bg-foreground text-background/80 py-16">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-sm">
                <Smartphone className="w-4 h-4 text-background/40 shrink-0" />
                <a href="tel:+393294516884" className="text-background/60 hover:text-background transition-colors">
                  Orlando 329 4516884
                </a>
              </li>
              <li className="flex items-center gap-3 text-sm">
        ...
        <div className="border-t border-background/10 mt-12 pt-8 text-center text-xs text-background/40 space-y-2">
          <p>© 2026 R.B. s.n.c. di Bertoluzzo e Ragazzo — Tutti i diritti riservati.</p>
